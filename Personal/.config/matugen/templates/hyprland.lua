...
hl.config({
    general = {
        ...
        ["col.active_border"] = { colors = {"rgba({{colors.primary.default.hex_stripped}}ff)", "rgba({{colors.secondary.default.hex_stripped}}ff)"}, angle = 45 },
        ["col.inactive_border"] = "rgba({{colors.surface_container_highest.default.hex_stripped}}aa)",
...
hl.bind(mainMod .. " + SHIFT + G", function()
  ...
  if game_mode == 1 then
    hl.notification.create({ text = "Game mode ON — 1920x1080@144; effects disabled", duration = 10000, color = "rgb(1b29a3)", font_size = 20 })
  else
